<script>
    ...
    import parserCSS from "prettier/plugins/postcss";
      ...
      import { filesLocalCopy, editorState, consolePanelState, consoleMessages, selectedAsset } from './store';
      ...
      export let fileName = 'script.js'
      export let type = 'loop( )'
      let mode = 'javascript'
      let parserMode = 'babel'
      if(mode == 'js'){
        mode = 'javascript'
        parserMode = 'babel'
      }
      ...
      <div class="editorMenu">
        {#if !readOnly}
          ...
          <div style="display: flex; justify-content: center; align-items: center;">
            ...
            <h5 style='font-family: "Source Code Pro"'>{type}</h5>
          </div>
          {#if readOnly}
