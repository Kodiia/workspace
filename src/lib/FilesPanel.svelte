...
<div class='panel' style='flex: 0 0 {panelWidth}; width: {panelWidth}; height: calc({$height}px - 70px); z-index: 2;' >
    <button bind:this={button} class="panelButton" on:click={()=>{filesPanelState.set(false);}} >    
    <!-- {#if !panelState}
